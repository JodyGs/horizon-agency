			...
			<div className="flex flex-col justify-center md:top-0 mt-28 lg:mt-36  items-center">
				<div className="flex flex-col items-center justify-center">
					<div className="border-[1px] rounded-full border-[#5515df] py-2 px-5">
						<h1 className="hidden md:block">Développement Fullstack & Intelligence Artificielle</h1>
						<h1 className="block md:hidden">Fullstack & IA</h1>
					</div>
					<H1
						...
						title="Sécurisez vos données, optimisez votre productivité"
					/>

					<p className="lg:w-[70%] text-center lg:text-2xl mt-2 dark:text-neutral-300 text-neutral-700 flex flex-col items-center space-y-2">
						<span>Expert en sécurisation des infrastructures et développement IA.</span>
						<span>
							Webservices haute performance, Safe Data et consulting technique spécialisé.
						</span>
					</p>
				...
				>
					{HeroImage.map((item, index) => (
						...
						>
							<Image
								alt="Cybersécurité et intelligence artificielle"
								className="overflow-hidden w-full h-auto"
								height={247}
								src={item.img}
								width={103}
								priority
								sizes="(max-width: 768px) 25vw, (max-width: 1200px) 15vw, 103px"
							/>
						</ComponentTransition>
					))}
				</motion.div>
