const Buttons = ({ className = "", title = "" }) => {
	return (
		<button
			className={`${className}dark:bg-neutral-100 bg-neutral-950 transition-all duration-1000 hover:delay-75 hover:bg-neutral-950 group px-6 py-2 overflow-hidden relative rounded-full`}
		>
			<h3 className="dark:text-black text-white font-semibold transition-all duration-500 group-hover:translate-y-[-150%]">
				{title}
			</h3>
			<h3 className="dark:text-black text-white font-semibold group-hover:text-black group-hover:dark:text-white z-[99] transition-all duration-500 absolute translate-y-[10%] group-hover:translate-y-[-100%]">
				{title}
			</h3>
